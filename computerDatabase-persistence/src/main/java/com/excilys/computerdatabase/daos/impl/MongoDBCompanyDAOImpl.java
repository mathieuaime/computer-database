...
@Repository
public class MongoDBCompanyDAOImpl implements CompanyDAO {
    ...
    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(MongoDBCompanyDAOImpl.class);
