...
@Repository
public class MongoDBUserRoleDAOImpl implements UserRoleDAO {

    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(MongoDBUserRoleDAOImpl.class);
